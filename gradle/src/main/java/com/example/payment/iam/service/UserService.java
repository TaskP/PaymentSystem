...
public class UserService {
    ...
    public User create(final User user) {
        ...
        final ValidationException vex = userFactory.getValidationException(userFactory.setUserIdIfNeeded(user));
        if (vex != null) {
            throw vex;
        }
    ...
    public User update(@Valid final User user) {
        final ValidationException vex = userFactory.getValidationException(user);
        if (vex != null) {
            throw vex;
        }
