...
public class Transaction implements Serializable {
     ...
     */
    @Column(name = "reference_id", nullable = true, insertable = false, updatable = false, unique = true)
    ...
    public void setReferenceTransaction(final Transaction referenceTransactionIn) {
        ...
        if (referenceTransactionIn != null) {
            setReferenceId(referenceTransactionIn.getUuid());
        }
    }
    ...
    public String toString() {
        return "Transaction [Type=" + getType() + ", uuid=" + uuid + ", amount=" + amount + ", status=" + status + ", referenceId=" + referenceId
                + ", merchantId=" + merchantId + ", customerEmail=" + customerEmail + ", customerPhone=" + customerPhone + ", epoch=" + epoch + ", merchant="
                + merchant + ", referenceTransaction=" + referenceTransaction + "]";
    }
